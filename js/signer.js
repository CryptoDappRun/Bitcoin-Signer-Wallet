...
console.log("Current Fee:",Coins[coinjs.pub].Fee)
ChainFee=Coins[coinjs.pub].Fee *1
$("#CurrentChainID").html( '<img src="images/' + Coins[coinjs.pub].Name + '.png" />' +  ' ' + Coins[coinjs.pub].Name+" Chain")


//large pack may get high fee,get real block fee is not handy.
//GetFee(Coins[coinjs.pub].Symbol)
	...
	$("#recipients .addressAddTo").click(function(){
		if($("#recipients .addressRemoveTo").length<19){
			...
			document.getElementById('SelfAddressID').disabled = false;
			document.getElementById('SelfAmountID').disabled = false;
			...
			document.getElementById('SelfAddressID').disabled = true;
			document.getElementById('SelfAmountID').disabled = true;
...
console.log("add output")
				...
				console.log("a:",a)
				console.log("amount:",$(".amount",o).val())
...
console.log("tx:",tx )
console.log("transaction info:",tx.serialize())
...
/* code for the qr code scanner */
	...
	$(".qrcodeScannerBroadcast").click(function(){
...
$('#redeemFrom').on('input', function() { 
var redeem = redeemingFrom($(this).val());	


	console.log("redeem:",redeem)

	if (redeem.from=="address") {
				 $("#redeemFromBtn").click()
	...
	function totalInputAmount(){
		...
		$.each($("#inputs .txIdAmount"), function(i,o){
			if(isNaN($(o).val())){
				...
				MyBalance=$("#totalInput").html() *  1 - ChainFee

						//MyBalance=$("#totalInput").html() *  1
		//console.log("MyBalance:",MyBalance)
	//	$("#SelfAmountID").val(MyBalance)
$("#SelfAmountID").val((MyBalance>0)?MyBalance:'0.00');
...
console.log("Single Amount:",f)
MyBalanceTemp=MyBalance-f
					
$("#SelfAmountID").val((MyBalanceTemp>0)?MyBalanceTemp:'0.00');
					//	$("#SelfAmountID").val(MyBalanceTemp ) 
					}
				});
...
$("#transactionFee").val("0.0000001");

}



ChainFee=$("#transactionFee").val() * 1

// min fee
if (ChainFee < 0.000001 ) {
ChainFee= 0.000001
$("#transactionFee").val("0.0000001");
...
validateOutputAmount();
	...
	function totalFee(){
		...
		var fee=0.001
		var fee1 = (($("#totalInput").html()*1) - ($("#totalOutput").html()*1)).toFixed(8);
...
console.log("**********************")
console.log("coinjs.pub:", "0x"+(coinjs.pub).toString(16)  )
console.log("coinjs.priv:","0x"+(coinjs.priv).toString(16) )
console.log("coinjs.multisig:","0x"+(coinjs.multisig).toString(16) )
console.log("coinjs.hdkey.pub:","0x"+(coinjs.hdkey.pub).toString(16) )
console.log("coinjs.hdkey.prv:","0x"+(coinjs.hdkey.prv).toString(16) )
 console.log("**********************")
		...
		ChainFee=Coins[coinjs.pub].Fee

		//ChainFee=$("#transactionFee").val() * 1 
		$("#transactionFee").val(ChainFee )
		console.log("coinjs.pub:",coinjs.pub)
		console.log("ChainFee:",ChainFee)
...
console.log("coins.pub",coinjs.pub)
console.log("o[0]",o[0])
console.log("o[0]",o[1])
console.log("o[0]",o[2])
console.log("o[0]",o[3])
